...
public class CatConsumerConfig
{
    ...
    @Bean
    public ConcurrentKafkaListenerContainerFactory<String, CatDto> createCatFactory()
    {
    ...
    @Bean
    public ConcurrentKafkaListenerContainerFactory<String, Integer> byIdCatFactory()
    {
