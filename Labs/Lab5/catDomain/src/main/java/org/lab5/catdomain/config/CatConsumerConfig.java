package org.lab5.catdomain.config;
...
public class CatConsumerConfig
{
    ...
    @Bean
    public ConsumerFactory<String, Cat> consumerFactory()
    {
        ...
        props.put(JsonDeserializer.VALUE_DEFAULT_TYPE, Cat.class);

        return new DefaultKafkaConsumerFactory<>(props);
    }

    @Bean
    public ConcurrentKafkaListenerContainerFactory<String, Cat> createKittyFactory()
    {
