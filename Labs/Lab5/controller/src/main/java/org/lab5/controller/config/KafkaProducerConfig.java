...
public class KafkaProducerConfig {
    ...
    @Bean
    public KafkaTemplate<String, OwnerDto> createOwnerTemplate() {
        return new KafkaTemplate<>(producerFactoryOwner());
    }

    @Bean
    public ProducerFactory<String, CatDto> producerFactoryCat() {
        Map<String, Object> props = new HashMap<>();
        props.put(ProducerConfig.BOOTSTRAP_SERVERS_CONFIG, bootstrapServers);
        props.put(ProducerConfig.KEY_SERIALIZER_CLASS_CONFIG, StringSerializer.class);
        props.put(ProducerConfig.VALUE_SERIALIZER_CLASS_CONFIG, JsonSerializer.class);
    ...
    @Bean
    public KafkaTemplate<String, CatDto> createCatTemplate() {
    ...
    @Bean
    public KafkaTemplate<String, FilterDto> filtersTemplate() {
    ...
    @Bean
    public KafkaTemplate<String, Integer> getCatTemplate() {
        return new KafkaTemplate<>(producerFactoryById());
    }

    @Bean
    public ProducerFactory<String, CatCreate> producerFactoryCatCreate() {
        Map<String, Object> props = new HashMap<>();
        props.put(ProducerConfig.BOOTSTRAP_SERVERS_CONFIG, bootstrapServers);
        props.put(ProducerConfig.KEY_SERIALIZER_CLASS_CONFIG, StringSerializer.class);
        props.put(ProducerConfig.VALUE_SERIALIZER_CLASS_CONFIG, JsonSerializer.class);
    ...
    @Bean
    public KafkaTemplate<String, CatCreate> createCatCreateTemplate() {
        return new KafkaTemplate<>(producerFactoryCatCreate());
    }
    ...
    @Bean
    public KafkaTemplate<String, FriendsDto> friendsTemplate() {
